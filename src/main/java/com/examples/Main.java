...
public class Main {
	...
	public static final String BASE_URI = "http://0.0.0.0:"
		+ System.getProperty("simple.rest.service.port", "8080") + "/myapp/";
			...
			.register(new AbstractBinder() {
				...
				protected void configure() {
					...
					bind(EmployeeServiceImpl.class).to(EmployeeService.class)
						.in(Singleton.class);
					bindAsContract(
						new TypeLiteral<LinkedHashMap<String, Employee>>() {})
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(
			String.format("Jersey app started with endpoints available at "
